...
def generate_feedback(edit_list):
    ...
    for error in errors_to_present:
        ...
        if "R:VERB:SVA" in target:
            ...
            out_dict['edit_' + str(error_count)] = {"response_short": response_short, "line_1":line_1, "response_1":{'correct':response_1_correct, 'incorrect':response_1_incorrect}, 'response_2':{'correct':response_2_correct, 'incorrect':response_2_incorrect}}
            error_count += 1
